 ...
 * 
 * 3.Mostrar la media de los ejercicios entregados por un estudiante (si los entregó todos; en caso
 * contrario, la media es 0).
 * 
 * 4.Mostrar la cantidad de estudiantes que han entregado todos los ejercicios y tienen una media
 * superior o igual a un 5.
 * 
 * 5.Mostrar el número de estudiantes que han presentado un ejercicio dado.
 * 
 * 6.Dado el número de un ejercicio, mostrar la nota media obtenida por los estudiantes que lo
 * presentaron.
 * 
...
public class EjercicioNotas {
  ...
  /**
   * Main principal del programa, con el menú con las 10 opciones y las llamadas a las funciones.
   * 
   * 
  ...
  /**
   * Funcion menu que sirve para mostrar el menu por pantalla, todas sus opciones y donde hay que
   * tener en cuenta lo siguiente:
   * 
   * •Cuando una opción necesite saber a qué estudiante nos referimos damos su número (empezamos en
   * 1) y al mostrar el resultado tiene que salir este número y su nombre.
   * 
   * •Cuando una opción necesite saber a qué ejercicio nos referimos damos su número (empezamos en
   * 1).
   * 
  ...
  public static int menu(int opcionEscogida, boolean notasGeneradas) {
    ...
    System.out
    .println("4.Mostrar la cantidad de estudiantes que han entregado todos los ejercicios y "
  ...
  /**
   * Funcion que genera las notas de cada estudiante y ejercicio de manera aleatoria
   * 
   * @param alumnosNotas
   * @return
   */
  ...
  public static void ejerciciosEntregados(int numeroEstudiante, int[][] alumnosNotas) {
    ...
    System.out.println(
        "El Estudiante " + numeroEstudiante + " ha hecho " + ejerciciosHechos + " ejercicios.");

  }

  /**
   * Funcion que muestra la media de un estudiante si ha entregado todos los ejercicios
   * 
  ...
  public static void mediaEjerciciosEntregados(int numeroEstudiante, int[][] alumnosNotas) {
    ...
    if (mediaAlumno == 0) {
      System.out.println("La media del Estudiante " + numeroEstudiante
          + " es 0 por no entregar todos los ejercicios");
    } else {
  ...
  /**
   * Funcion que muestra la cantidad de alumnos que han entregado todos los ejercicios y tienen
   * media superior a 5
   * 
   * @param alumnosNotas
   */
  ...
  /**
   * Funcion que muestra la nota media de los alumnos que presentaron un ejercicio seleccionado
   * 
